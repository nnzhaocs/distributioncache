...
RUN go get github.com/ngaut/log && go get github.com/allegro/bigcache && go get launchpad.net/gozk/zookeeper && go get github.com/secondspass/go-rejson && go get github.com/gomodule/redigo/redis
