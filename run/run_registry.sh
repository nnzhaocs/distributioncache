...
docker run -p 5000:5000 --rm -v /home/lustre/dockerimages/layers:/var/lib/registry -e REGISTRY_STORAGE_CACHE_HOSTIP=192.168.0.220 --name nnregistry -t nnzhaocs/distribution:latest
